...
export default function PassengerList({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.welcomeText}>Please select a Passenger !</Text>
      <Text style={styles.userTypeText}>There are 4 passengers available in your area</Text>
      <View style={styles.passengers}>
        <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.passengerButton} onPress={handlePassengerSelection}>
                <Ionicons style={styles.image} name="person-circle-outline" size={44} color="black" />
                <Text style={styles.buttonText}>Mohamed Salah</Text>
            ...
            <TouchableOpacity style={styles.passengerButton} onPress={handlePassengerSelection}>
                ...
                <Text style={styles.buttonText}>Maram K.</Text>
        ...
        <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.passengerButton} onPress={handlePassengerSelection}>
                <Ionicons style={styles.image} name="person-circle-outline" size={48} color="black" />
                <Text style={styles.buttonText}>Jane Doe</Text>
            ...
            <TouchableOpacity style={styles.passengerButton} onPress={handlePassengerSelection}>
                <Ionicons style={styles.image} name="person-circle-outline" size={48} color="black" />
                <Text style={styles.buttonText}>Elyes S.</Text>
